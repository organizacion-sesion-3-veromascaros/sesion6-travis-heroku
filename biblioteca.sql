...
('Friends', 'La serie trata sobre la vida de un grupo de amigos —Chandler Bing, Phoebe Buffay, Monica Geller, Ross Geller, Rachel Green y Joey Tribbiani— que residen en Manhattan, Nueva York. Suceden tanto buenos como malos momentos, pero con una crítica cómica a los hechos más trascendentales de la actualidad.',' David Crane, Marta Kauffman','http://www.sensacine.com/series/serie-49/video-19366183/', '1994-12-22'),
('Juego de Tronos', 'La serie nos sitúa en Invernalia, uno de los siete reinos del continente de Poniente. Tras un largo verano, Lord Eddard "Ned" Stark, señor de Invernalia, es llamado a ocupar el cargo de Mano del Rey. Se verá obligado a dejar su tierra para unirse a la corte del rey Robert Baratheon "El Usurpador",, señor de los Siete Reinos, hombre díscolo y otrora un gran guerrero. Pronto, los principios y la ética de Ned Stark chocarán con la forma de vida del rey Baratheon, pero incluso más con la de los Lannister, una de las siete familias más importantes del reino de la cual la reina Cersei Lannister proviene. No menos tormentosa será la relación con su hermano Jaime Lannister  y el enano Tyrion.' , 'David Benioff, D.B. Weiss', 'http://www.sensacine.com/series/serie-7157/video-19552337/', '2011-04-17'),
('Los Simpson', 'Los Simpson (en inglés, The Simpsons) es una serie estadounidense de comedia, en formato de animación, creada por Matt Groening para Fox Broadcasting Company y emitida en varios países del mundo. La serie es una sátira de la sociedad estadounidense que narra la vida y el día a día de una familia de clase media de ese país (cuyos miembros son Homer, Marge, Bart, Lisa y Maggie Simpson) que vive en un pueblo ficticio llamado Springfield.', 'Matt Groening', 'http://www.sensacine.com/series/serie-290/video-19355922/', '1989-12-18');
